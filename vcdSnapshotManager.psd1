@{
    ...
    RootModule = 'vcdSnapshotManager.psm1'
    ...
    Description = 'PowerShell module for managing VMware vCloud Director snapshots. Provides functions to create, retrieve, and remove snapshots for vApps and VMs, as well as query vApps using the vCD API.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('VMware', 'vCloudDirector', 'vCD', 'Snapshot', 'vApp', 'Cloud', 'API', 'REST')
